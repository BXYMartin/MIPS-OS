...
start:
        /OSLAB/gxemul -E testmips -C R3000 -M 64 -d gxemul/fs.img ~/16231086-lab/gxemul/vmlinux

debug:
        /OSLAB/gxemul -E testmips -C R3000 -M 64 -d gxemul/fs.img -v -V ~/16231086-lab/gxemul/vmlinux
